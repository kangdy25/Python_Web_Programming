      ...
      <div class="container">
        <div class="columns is-centered">
          <div class="column is-6-tablet is-5-desktop is-4-widescreen">
            <h2 class="title has-text-centered mb-5" style="font-weight: 800; font-size: 2rem; color: #0f172a;">PyBoard 회원가입</h2>
            <form @submit.prevent="handleSubmit" class="box">
              ...
              <div class="field mt-5">
                <button
                  ...
                  type="submit"
                  style="border-radius: 10px; font-weight: 600; font-size: 1rem; height: 3rem;"
                >
                  회원가입 완료
                </button>
              </div>
              <div class="has-text-centered mt-4">
                <router-link class="is-link" to="/login" style="color: #6366f1; font-weight: 600; font-size: 0.9rem;">
                  이미 계정이 있으신가요? 로그인하기
                </router-link>
              </div>
            </form>
